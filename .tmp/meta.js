import ButtonMeta from '/home/patrick/code/github/lowcode-rgl-demo/lowcode/button/meta'
import GridLayoutMeta from '/home/patrick/code/github/lowcode-rgl-demo/lowcode/grid-layout/meta'
import PageMeta from '/home/patrick/code/github/lowcode-rgl-demo/lowcode/page/meta'
...
function fillRealVersion(meta, packageName = 'lowcode-rgl-demo', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [ButtonMeta,GridLayoutMeta,PageMeta];
const components = [];
const npmInfo = {"package":"lowcode-rgl-demo","version":"0.1.0"};
